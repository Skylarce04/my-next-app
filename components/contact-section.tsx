...
const contactInfo = [
  {
    ...
    label: "Address",
    value:
      "Jl. Cipinang Lontar II No.4, RT.1/RW.8, Cipinang, Kec. Pulo Gadung, Kota Jakarta Timur, DKI Jakarta 13240",
  },
  {
    icon: Phone,
    label: "Phone",
...
useEffect(() => {
  ...
  const onTouchEnd = () => {
    ...
    // Swipe left
    if (distance > minSwipeDistance && slide < 1) {
      setSlide(slide + 1)
    }

    // Swipe right
    if (distance < -minSwipeDistance && slide > 0) {
      setSlide(slide - 1)
    }
  }
...
Saya ${formData.name} ingin menyampaikan permohonan doa:

"${formData.message}"

Mohon didoakan. Terima kasih. Tuhan memberkati.`
              ...
              >
                ...
                <div className="min-w-full p-8">
                  ...
                  <p className="text-sm text-muted-foreground mb-6">
                    Share your prayer needs with us. Our team will pray for you.
                  </p>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <label className="block text-sm font-medium mb-2">
                    ...
                    >
                      {loading ? (
                        ...
                        "Submit Prayer Request via Whatsapp"
                      )}
                    </Button>
                  </form>
                </div>
